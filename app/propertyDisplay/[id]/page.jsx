...
// import PropertyData from "@/Data/BasicData";
...
export default async function PropertyDisplayScreen({ params }) {
  ...
  const FullAddress =
    "No." + doorNo + ", " + area + ", " + city + "-" + pincode + ", " + state;
      ...
      <div className="w-full h-[20%] flex justify-center items-center ">
        <div className="flex w-[90%] space-x-4 border justify-around ">
          ...
          <div className="w-auto flex flex-col justify-center">
            ...
            <div className="text-lg self-center text-emerald-600">{rent}</div>
          </div>
          <div className="w-auto flex flex-col justify-center">
            <div className="text-lg self-center">₹ Deposit</div>
            <div className="text-lg self-center text-emerald-600">
              {deposit}
            </div>
          </div>
        </div>
      </div>
      <div className=" w-full border ml-2 h-[80%] flex justify-center items-center space-x-16">
        <div className="flex w-[55%] my-10 py-1">
          <Carousel
            opts={{
              align: "center",
              loop: true,
        ...
        <div className="flex flex-col w-[30%] my-10  py-1">
          <div>
            <div className="flex w-full border">
              <div className="flex w-[50%] border">
            ...
            <div className="flex w-full border">
              ...
              <div className="flex w-[50%] border">
                ...
                <div className="flex flex-col w-[80%] py-3 ">
                  <div className="text-lg self-start">Number of Bathrooms</div>
                  <div className="text-md self-start">{bathrooms}</div>
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-col border-2 py-3 px-3">
            <div className="flex">
              <div className="p-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="text-lg self-center">Amenities</div>
            </div>
